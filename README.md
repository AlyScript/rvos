...
In the unlikely case that you are running RV64 natively, then all you need to run rvos is Qemu. 

Specifically, `qemu-system-riscv64` which is available via most package managers. 
...
I wouldn't recommend using prebuilt binaries, but there are many available and I can't guarantee they'll be pain free. In any case, _*make sure your toolchain targets 64-bit riscv.*_
